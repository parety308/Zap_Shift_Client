        ...
        <div className="drawer lg:drawer-open w-11/12 ">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className="px-4 text-2xl font-bold">ZapShift DashBoard</div>
                </nav>
                {/* Page content here */}
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        <li >
                            <Link to='/dashboard/my-parcels' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="MyParcels">
